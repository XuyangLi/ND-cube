...
int main(int argc, char * argv[]) {
    ...
    const double ext_x = 40.0;        // external box x-width
    const double ext_y = 40.0;        // external box y-width
    const double ext_z = 40.0;        // external box z-width
    ...
    sensor->SetArea(-20.0,-20.0,-5.0,20.0,20.0,35.0);
    ...
    vFE->SetArea(-20.0,-5.0,-5.0,20.0,35.0,35.0);
    
    vf->SetElectricFieldRange(0, 200); // sets the range of the color palette
    vf->SetVoltageRange(0, 200);
    vf->PlotContour("e");
    //vf->PlotSurface("e");
    //vFE->Plot();
